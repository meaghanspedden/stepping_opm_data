classdef OptiTrackerSimple_London_newtrig < handle
    ...
    methods
        ...
        function obj = OptiTrackerSimple_London_newtrig()
            addpath(genpath('C:\Users\omotion\Documents\NatNetSDK'));
            ...
            %     try
            %         NET.addAssembly('C:\Users\omotion\Documents\Meaghan\TriggerLib.dll');
        ...
        function Start(obj,Filename)
            ...
            n = 30;%Number of trials for each mode            
    ...
    methods (Access = private)
        ...
        function PrepareFigure(obj)
           set(0, 'DefaultFigurePosition', [ 1921          -3        1920        1200]);
